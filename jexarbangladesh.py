...
[C][B][FF6347] Developer    JAZA  BLRX""", uid
            ...
            if "1200" in data.hex()[0:4] and b"WELCOME TO [FFFFF00]Hyper Himuu [ffffff]BOT" in data:
            	pass
            else:
    ...
    f"[B][FFA500]• Bio: [FFFFFF]{bio}\n"
	            ...
	            if "1200" in data.hex()[0:4] and b"/help" in data:
	                ...
	                clients.send(
	                    self.GenResponsMsg(
		                        f"""[B][C][FFFF00] WELCOME TO [ffffff]Hyper Himuu BOT  !! 

[C][B][00FF00]/🤔likes [id] -> [C][B][FFFFFF]১০০ লাইক নেও
		
[FF0000] /🤔info [id] -> [C][B][FFFFFF]সকল info দেখো
...
[00FF00َ] /🤔admin -> [C][B][FFFFFF]Bot Ke Admin Ke Bare Me Jane
 ...
 /🤔inv [ID] -> [C][B][FFFFFF] ৫ জন ইনভাট পাঠাও
		-------------------------------
...
if __name__ == "__main__":
    try:
        client_thread = FF_CLIENT(id="3900968880", password="4782FEBA4C05142F8BA3EAB711B57893A3233ACBBE8D19B3BA93D902066D479B")
        client_thread.start()
    except Exception as e:
